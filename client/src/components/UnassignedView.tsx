                  ...
                  <div key={todo.id}>
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="shrink-0 p-1.5 rounded-lg text-gray-300 dark:text-gray-600 hover:bg-primary-50 dark:hover:bg-primary-500/10 hover:text-primary-500 transition-all"
                        title="Przypisz datę"
                      >
