...
export const SCOPE_MODULES = ['todo', 'meals', 'home', 'households', 'finance', 'settings'] as const;
...
const SCOPE_PATTERN = /^(todo|meals|home|households|finance|settings):(read|write)$/;
