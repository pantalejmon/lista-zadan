import { ApiTokenService } from '@platform/api-token/domain/api-token.service';
import { ALL_SCOPES, isValidScope, type ApiScope } from '@platform/api-token/domain/api-scope';
